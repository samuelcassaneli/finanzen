    ...
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 animate-fade-in-fast">
      <GlassCard className="w-full max-w-md mx-4">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-white">Edit Savings Goal</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
                <label htmlFor="goal-current" className="text-sm text-gray-300 mb-1 block">Current Amount</label>
